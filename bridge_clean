...
<div id="startScreen">
  <div id="prueba">RepoFusion 2.4 HDR</div>
  <div id="label">Plato 01</div>

  <div class="arrowContainer">
    <button class="arrow" onclick="prev()">â†</button>
    <button class="arrow" onclick="next()">â†’</button>
  </div>
